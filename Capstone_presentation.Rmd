...
How could a cafe increases his profits?
...
visit.dat <- read.csv("~/Documents/GitHub/DS_Capstone_Cafa_Analysis/Hourlydata.csv")
...
```{r echo=FALSE, cache=FALSE, results=TRUE, warning=FALSE, comment=FALSE, warning=FALSE}
#Downloading the data
Items <- read.csv("~/Documents/GitHub/DS_Capstone_Cafa_Analysis/Items.csv")
...
```
Flat White is the most seller and most profitable item!

## Items with more than 1,500 Pieces sold in 11 months
```{r, echo=FALSE, cache=FALSE}
Items$item[Items$count > 1500]
```
...
- These are sweets, maybe it is not a good idea to have many desserts in a coffee shop.
...
```{r echo=FALSE, cache=FALSE, results=TRUE, warning=FALSE, comment=FALSE, warning=FALSE}
#Downloading the data
sales.data <- read.csv("~/Documents/GitHub/DS_Capstone_Cafa_Analysis/sales-data.csv")
